...
import com.lq.maintenance.common.util.HttpUtils;
import com.lq.maintenance.common.util.JwtTokenUtils;
...
//		String password = jsonObject.getString("password");
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		JwtAuthenticatioToken token = new JwtAuthenticatioToken(authResult.getPrincipal(), authResult.getCredentials(), JwtTokenUtils.generateToken(authResult));
